...
func (a *Controller) serviceExportToServiceImport(obj runtime.Object, numRequeues int, op syncer.Operation) (runtime.Object, bool) {
	...
	if !found {
		...
		a.updateExportedServiceStatus(svcExport.Name, svcExport.Namespace, corev1.ConditionFalse, reasonServiceUnavailable,
	...
	if !ok {
		a.updateExportedServiceStatus(svcExport.Name, svcExport.Namespace,
			corev1.ConditionFalse, reasonInvalidServiceType,
...
func (a *Controller) serviceExportUploadTransform(obj runtime.Object, numRequeues int, op syncer.Operation) (runtime.Object, bool) {
	...
	obj, found, err := a.serviceSyncer.GetResource(localServiceExport.Name, localServiceExport.Namespace)
	if err != nil {
		// some other error. Log and requeue
	...
	if !found {
		...
		a.updateExportedServiceStatus(localServiceExport.Name, localServiceExport.Namespace,
			corev1.ConditionFalse, reasonServiceUnavailable,
			"Service to be exported doesn't exist")
...
func (a *Controller) serviceToRemoteServiceExport(obj runtime.Object, numRequeues int, op syncer.Operation) (runtime.Object, bool) {
	...
	a.updateExportedServiceStatus(localServiceExport.Name, localServiceExport.Namespace,
		corev1.ConditionFalse, reasonServiceUnavailable, "Service to be exported was deleted")
